...
public class GestorBLL {
     ...
     * Fases: iniciais das 3 primeiras palavras; variação da 3.ª, 2.ª e 1.ª
     * posição com letras do nome; sufixo numérico como último recurso.
     * @param nome Nome completo do docente.
     * @return Sigla única de 3 caracteres.
     */
